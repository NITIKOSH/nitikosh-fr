...
const Left = () => {
	return (
		<div className='w-full h-full flex flex-col  justify-center container mx-auto text-[#211D3D]'>
			<div className='text-5xl font-extrabold w-3/5 font-lato leading-[1.4]'>
				Secure Justice with Blockchain : The Evault Revolutionizing
				Legal Record Handling
			</div>
			<div className='w-1/2 pt-4 font-open-sans font-light text-xl'>
				Our platform offers efficient storage, management, and sharing
